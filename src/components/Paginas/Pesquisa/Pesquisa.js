            ...
            <div className="CardImoveis">
              ...
              <Link
                to={
                  ...
                  (imovel.qtdeQuarto === 0 ? "" : (imovel.qtdeQuarto === 1 ?  "+com+"+imovel.qtdeQuarto+"+quarto" : "+com+"+imovel.qtdeQuarto+"+quartos")) +
                  (imovel.qtdeSuites === 0 ? "" : (imovel.qtdeSuites === 1 ?  "+com+"+imovel.qtdeSuites+"+suite" : "+com+"+imovel.qtdeSuites+"+suites")) +
                  (imovel.qtdeBanheiro === 0 ? "" : (imovel.qtdeBanheiro === 1 ?  "+com+"+imovel.qtdeBanheiro+"+banheiro" : "+com+"+imovel.qtdeBanheiro+"+banheiros")) +
                  (imovel.qtdeVagas === 0 ? "" : (imovel.qtdeVagas === 1 ?  "+com+"+imovel.qtdeVagas+"+vaga+na+garagem" : "+com+"+imovel.qtdeVagas+"+vagas+na+garagem")) 
                   +
                  "&tipoNegociacao=" +
