        ...
        <div className="conteudoImovel ImovelRevenda">
          <div className="esquerdo topoImovel">
            ...
            <div className="infomacoesImovel">
              <p className="endrecoImovel">
                {data.imovel.categoriaImovel} com {data.imovel.areaTotal + " m², "} localizado na {data.imovel.logradouro}
                , {data.imovel.numeroLogradouro} {data.imovel.complemento && (data.imovel.complemento)} - {data.imovel.bairro} — {data.imovel.cidade}
              </p>
          ...
          <div className="direito formImovel">
            <div className="dentroFormImovel">
              <div className="tituloForm">
                <h3>
                  Quer ter mais informações sobre o imóvel, mande mensagem agora
              ...
              <div className="informacoesCadastro">
                <p className="ligarFormContato">
                  Se preferir mande mensagem no WhatsApp ou ligue (00)
                  0000-0000, estamos esperando seu contato.
                </p>
          ...
          <div className="outrosInformacoesImovel">
            ...
            <div className="detalhesImoveis">
              ...
              <div className="itens">
                ...
                {data.imovel.valorImovel != 0 && (
                  <p className="detalhesImoveis">
                    <b>Valor do imóvel:</b> {data.imovel.valorImovel.toLocaleString("pt-br", {style: "currency", currency: "BRL", })}
                  </p>
                )}
                {data.imovel.valorEntrada != 0 && (
                  <p className="detalhesImoveis">
                    <b>Valor da entrada:</b> {data.imovel.valorEntrada.toLocaleString("pt-br", {style: "currency", currency: "BRL", })}
                  </p>
                )}
                {data.imovel.valorParcela != 0 && (
                  <p className="detalhesImoveis">
                    <b>Valor da parcela:</b> {data.imovel.valorParcela.toLocaleString("pt-br", {style: "currency", currency: "BRL", })}
                  </p>
                )}
                {data.imovel.valorIPTU != 0 && (
                  <p className="detalhesImoveis">
                    <b>Valor do IPTU:</b> {data.imovel.valorIPTU.toLocaleString("pt-br", {style: "currency", currency: "BRL", })}
                  </p>
                )}
                {data.imovel.valorCondominio != 0 && (
                  <p className="detalhesImoveis">
                    <b>Valor do condomínio:</b> {data.imovel.valorCondominio.toLocaleString("pt-br", {style: "currency", currency: "BRL", })}
                  </p>
                )}
                {data.imovel.areaTotal != 0 && (
                  <p className="detalhesImoveis">
                    <b>Área total:</b> {data.imovel.areaTotal.toLocaleString("pt-br")}
                  </p>
                )}
                {data.imovel.areaConstruida != 0 && (
                  <p className="detalhesImoveis">
                    <b>Área construída:</b> {data.imovel.areaConstruida.toLocaleString("pt-br")}
                  </p>
                )}
                ...
                <p className="detalhesImoveis">{data.imovel.logradouro}, {data.imovel.numeroLogradouro} {data.imovel.complemento && (data.imovel.complemento)}</p>
            ...
            <div className="caractsImoveis">
              <h2 className="titulocaractsImoveis">
